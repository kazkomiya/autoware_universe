...
{
public:
  /// \param reporter Where the controller reports what it meets. It has to outlive this
  /// object.
  MpcLateralController(const MpcLateralControllerConfig & config, ControllerReporter & reporter);
